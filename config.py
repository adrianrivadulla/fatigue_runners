...
gas_ylabels = {"VO2": "%VO2peak", "RQ": "VCO2/VO2", "Rf": "breaths/min", "VT": "l"}
...
couplings = [
    ("RTRUNK2PELVIS_VEL", "RHIP_VEL"),
    ("RHIP_VEL", "RKNEE_VEL"),
    ("RKNEE_VEL", "RANK_VEL"),
]

kinematics_titles = {
    "SFl": "Stride frequency",
    "DF": "Duty factor",
    "RCOM": "vCOM",
...
coord_titles = {
    "RTRUNK2PELVIS_VEL__RHIP_VEL": "Trunk-pelvis ${\omega}$ \u2014 Hip ${\omega}$",
